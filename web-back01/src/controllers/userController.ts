...
//controller fuction to create a new project
    ...
    try {
        ...
        const promptEnhanceResponse = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: 'system',
                    content: `ou are a prompt enhancement specialist. Take the user's website request and expand it into a detailed, comprehensive prompt that will help create the best possible website.
...
`
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `i have enchance your promot to ${enhancePrompt}`,
                projectId: project.id
            }
        })
