...
// const steps = [
//     {icon : ScanLineIcon,label:"Analyzing your requuest"},
...
//     const Icon = steps[current]


//   return (
//     <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflo-hidden text-white'>
...
//                     </div>
//                     {/* steps label -fade using transition only (no visible start) */}
...
//                     <p className='text-xs text-gray-400 mt-2 transition-opacity duration-700 opacity-100'>This may take few minutes...</p>
//             </div>
//      </div>
//   )
// }
...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
      ...
      <p
        key={current}
        className="mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700 ease-in-out"
      >
        {steps[current].label}
      </p>
